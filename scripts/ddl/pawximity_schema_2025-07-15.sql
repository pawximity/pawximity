...
CREATE SEQUENCE pawximity.utah_streams_hydrography_ugrc_ogc_fid_seq
	...
	START 1
	CACHE 1
	NO CYCLE;-- pawximity.utah_county_boundary_ugrc definition
...
CREATE INDEX utah_county_boundary_ugrc_geom_geom_idx ON pawximity.utah_county_boundary_ugrc USING gist (geom);
...
CREATE INDEX utah_lakes_hydrography_ugrc_geom_geom_idx ON pawximity.utah_lakes_hydrography_ugrc USING gist (geom);
...
CREATE INDEX utah_roads_osm_geom_geom_idx ON pawximity.utah_roads_osm USING gist (geom);
...
CREATE INDEX utah_springs_hydrography_ugrc_geom_geom_idx ON pawximity.utah_springs_hydrography_ugrc USING gist (geom);
...
CREATE INDEX utah_state_boundary_ugrc_geom_geom_idx ON pawximity.utah_state_boundary_ugrc USING gist (geom);
...
CREATE INDEX utah_streams_hydrography_ugrc_geom_geom_idx ON pawximity.utah_streams_hydrography_ugrc USING gist (geom);